...
export const HomePage = React.memo(({ navigate, menuItems }) => (
  <div className="fade-up-enter bg-[#F2F0E9]">
    ...
    {/* Elements Carousel */}
    <div className="w-full flex flex-col items-center py-16 md:py-32 border-b border-[#1C1C1C]/5 overflow-hidden bg-[#F2F0E9]">
      <div className="max-w-[2000px] w-[96%] px-4 md:px-8 mb-8 md:mb-16 flex flex-col md:flex-row justify-between items-start md:items-end border-b border-[#1C1C1C]/10 pb-8 arch-grid">
        <div>
    ...
    {/* Ritual Section */}
    <section className="w-full flex flex-col items-center py-24 md:py-40 bg-[#1C1C1C] text-[#F2F0E9] overflow-hidden border-y border-[#1C1C1C]">
      ...
      <div className="max-w-[2000px] w-[96%] px-4 md:px-8 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center arch-grid border-x-white/5">
