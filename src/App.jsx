...
const App = () => {
  ...
  return (
    <CartProvider>
      ...
      <div className={`w-full flex flex-col items-center font-sans text-[#1C1C1C] min-h-screen selection:bg-[#3A4D39] selection:text-[#F2F0E9] transition-opacity duration-1000 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
